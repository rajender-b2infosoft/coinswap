                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            Text('Let’s get started',style: CustomTextStyles.pageTitleMain,),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Center(
                                child: Text('To create ID and verify your identity you need to complete these 3 simple steps.',
    ...
    return Row(
      ...
      children: [
        SizedBox(
          ...
          child: Column(
            children: [
              (title=='Verify Email')? SizedBox(height: 8,):SizedBox(height: 0,),
              CustomImageView(
                imagePath: img,
                fit: BoxFit.fitWidth,
                width: (index==1)?74:45,
