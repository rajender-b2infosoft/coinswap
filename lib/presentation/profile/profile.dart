            ...
            child: SingleChildScrollView(
              child: Consumer<ProfileProvider>(
                ...
                if (provider.profileData == null ||
                    provider.profileData!.data.isEmpty) {
                  return Center(
                      child: Padding(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              border:
                                  Border.all(color: appTheme.main, width: 1),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  "${provider.name}",
                                  style: CustomTextStyles.main18_400,
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                            ...
                            SizedBox(
                                ...
                                child: Text(
                                  "${provider.email}",
                                  style: CustomTextStyles.color9898_15,
                                ))
                          ],
                        )
                      ],
                                ...
                                Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Center(
                                        child: Text(
                                          "\$${(double.parse(provider.totalBalance)).toStringAsFixed(5).replaceAll(RegExp(r'0+$'), '')}",
                                          overflow: TextOverflow.ellipsis,
                                          style: CustomTextStyles
                                              .color0072D_16_conversion,
                                        ),
                                      ),
                                    ),
                                    ...
                                    Text(
                                      "Wallet",
                                      style: CustomTextStyles.color9898_18,
                                    )
                                  ],
                                ),
                                VerticalDivider(
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Center(
                                        child: Text(
                                            (provider.status != null && provider.status!.isNotEmpty)
                                                ? provider.status![0].toUpperCase() + provider.status!.substring(1)
                                                : '',
                                            style: CustomTextStyles
                                                .color0072D_16_conversion),
                                      ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  var type = (profile.cryptoType == 'bitcoin')
                                      ? 'BTC'
                                      : (profile.cryptoType == 'ethereum')
                                          ? 'ETH'
                                          : (profile.cryptoType == 'tron')
                                      ? 'USDT'
                                      : 'Tron';
                                  var img = (type == 'BTC')
                                      ? ImageConstant.bit
                                      ...
                                      : ImageConstant.t;
                                  var color = (type == 'Tron')
                                      ? CustomTextStyles.red16
                                      : (type == 'BTC')
                                      ? CustomTextStyles.orange16
                                      : (type == 'ETH')
                                          ? CustomTextStyles.color5E8DF7_16
                                          : CustomTextStyles.green16;

                                  var balance =
                                  (profile.cryptoType == 'usdtTron')
                                      ? provider.usdtTronBalance
                                      : (profile.cryptoType == 'bitcoin')
                                          ? provider.btcBalance
                                          : (profile.cryptoType == 'ethereum')
                                              ? provider.ethBalance
                                              : provider.usdtBalance;

                                  return (profile.cryptoType != null)
                                      ? commonContainer(
                                          type, img, balance.toString(), color)
                                      : Container();
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              "Change Password",
                              style: CustomTextStyles.white17_400,
                            ),
                            Container(
                              padding: const EdgeInsets.symmetric(
