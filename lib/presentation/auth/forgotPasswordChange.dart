...
class ForgotPasswordChange extends StatefulWidget {
  ...
  const ForgotPasswordChange(
      {super.key, required this.email, required this.page});
                                ...
                                SizedBox(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      fillColor: hasFocusNew || hasValueNew
                                          ? appTheme.white1 : appTheme.f6f6f6,
                                      filled: true,
                                      labelText: 'Enter new password',
                                      labelStyle: TextStyle(
                                          color: hasFocusNew || hasValueNew
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      contentPadding:
                                          const EdgeInsets.symmetric(
                                              vertical: 10, horizontal: 13),
                                      fillColor: hasFocusConf || hasValueConf
                                          ? appTheme.white1 : appTheme.f6f6f6,
                                      filled: true,
                                      labelText: 'Re-enter new password',
                                      labelStyle: TextStyle(
                                          color: hasFocusConf || hasValueConf
                                              ? appTheme.main_mpin : Colors.grey,
                                          fontSize: 16,
                                          fontWeight: FontWeight.normal),
                                      border: OutlineInputBorder(
                                    ...
                                    validator: (value) => checkEmpty(
                                        value, 'Please re enter new password'),
                                  ),
                                ),
                                const SizedBox(
                                  height: 10,
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontFamily: 'Poppins',
                                        fontWeight: FontWeight.w400,
                                        color: provider.hasSpecialCharacter
                                            ? appTheme.green
                                            : appTheme.gray,
                                      ),
                                    ),
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (newPass != confPass) {
                      CommonWidget().snackBar(
                          context, appTheme.red, 'Password does not match.');
                      ...
                      provider.setLoding(false);
                        ...
                        .hasMatch(provider.confController.text)) {
                      CommonWidget().snackBar(context, appTheme.red,
